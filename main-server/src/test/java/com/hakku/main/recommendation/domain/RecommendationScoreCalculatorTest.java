...
class RecommendationScoreCalculatorTest {
    ...
    class PersonalColor {
        ...
        void keyColorMatchScoresFull() {
            var user = new UserPreferenceProfile("WINTER", Set.of(), Set.of(), Set.of());
            var keyMatch = new ProductFeatures("WINTER", "SUMMER", Set.of(), Set.of(), 0.0, 0.0);
            var subMatch = new ProductFeatures("SPRING", "WINTER", Set.of(), Set.of(), 0.0, 0.0);
        ...
        void noColorMatch() {
            var user = new UserPreferenceProfile("WINTER", Set.of(), Set.of(), Set.of());
            var product = new ProductFeatures("SPRING", "SUMMER", Set.of(), Set.of(), 0.0, 0.0);
        ...
        void caseInsensitive() {
            var user = new UserPreferenceProfile("winter", Set.of(), Set.of(), Set.of());
            var product = new ProductFeatures("WINTER", null, Set.of(), Set.of(), 0.0, 0.0);

            assertEquals(3.0, calculator.score(user, product).personalColor(), EPS);
        }

        @Test
        @DisplayName("season matches product color tags when keyColor is a hue")
        void seasonMatchesProductColors() {
            var user = new UserPreferenceProfile("SUMMER", Set.of(), Set.of(), Set.of());
            var product = new ProductFeatures("blue", null, Set.of("blue", "purple"), Set.of(), 0.0, 0.0);

            assertEquals(1.5, calculator.score(user, product).personalColor(), EPS);
        }
    }
    ...
    class Style {
        ...
        void fullOverlap() {
            var user = new UserPreferenceProfile(null, Set.of("cute", "pastel"), Set.of(), Set.of());
            var product = new ProductFeatures(null, null, Set.of(), Set.of("cute", "pastel"), 0.0, 0.0);
        ...
        void partialOverlap() {
            var user = new UserPreferenceProfile(null, Set.of("a", "b", "c", "d"), Set.of(), Set.of());
            var product = new ProductFeatures(null, null, Set.of(), Set.of("a", "b"), 0.0, 0.0);
        ...
        void noPreferences() {
            var user = new UserPreferenceProfile(null, Set.of(), Set.of(), Set.of());
            var product = new ProductFeatures(null, null, Set.of(), Set.of("cute"), 0.0, 0.0);
    ...
    class RecentAction {
        ...
        void recentTagsAccumulate() {
            var user = new UserPreferenceProfile(null, Set.of(), Set.of(), Set.of("cute", "retro"));
            var product = new ProductFeatures(null, null, Set.of(), Set.of("cute", "retro", "pastel"), 0.0, 0.0);
    ...
    class PopularityAndReview {
        ...
        void popularityClamped() {
            var user = new UserPreferenceProfile(null, Set.of(), Set.of(), Set.of());
            var half = new ProductFeatures(null, null, Set.of(), Set.of(), 0.5, 0.0);
            var over = new ProductFeatures(null, null, Set.of(), Set.of(), 5.0, 0.0);
        ...
        void reviewNormalized() {
            var user = new UserPreferenceProfile(null, Set.of(), Set.of(), Set.of());
            var good = new ProductFeatures(null, null, Set.of(), Set.of(), 0.0, 4.0);
    ...
    void perfectMatchTotal() {
        var user = new UserPreferenceProfile("WINTER", Set.of("cute", "pastel"), Set.of(), Set.of("cute"));
        var product = new ProductFeatures("WINTER", "SUMMER", Set.of(), Set.of("cute", "pastel"), 1.0, 5.0);
    ...
    void noSignalTotal() {
        var user = new UserPreferenceProfile("WINTER", Set.of("cute"), Set.of(), Set.of("retro"));
        var product = new ProductFeatures("SPRING", "AUTUMN", Set.of(), Set.of("formal"), 0.0, 0.0);
